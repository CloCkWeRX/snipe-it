                    ...
                    <div class="col-md-12">
                        ...
                        <fieldset name="remote-login" class="bottom-padded">
                            ...
                            <div class="form-group {{ $errors->has('alert_email') ? 'error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input type="email" name="alert_email" value="{{ old('alert_email', $setting->alert_email) }}" class="form-control" placeholder="admin@yourcompany.com,it@yourcompany.com" maxlength="191">

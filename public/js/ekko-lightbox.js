...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    header = '<div class="modal-header"' + (this.options.title || this.options.always_show_close ? '' : ' style="display:none"') + '><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h2 class="modal-title">' + (this.options.title || "&nbsp;") + '</h2></div>';
